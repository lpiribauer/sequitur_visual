(function (global, factory) {
    ...
    var SvgSaver = function () {
        ...
        _createClass(SvgSaver, [{
            key: "getHTML", value: function getHTML(el) {
            ...
            key: "getBlob", value: function getBlob(el) {
                var html = this.getHTML(el);
                return new Blob([html], {type: "text/xml"})
            }
        }, {
            key: "getUri", value: function getUri(el) {
                var html = this.getHTML(el);
            ...
            key: "asSvg", value: function asSvg(el, filename) {
            ...
            key: "asPng", value: function asPng(el, filename) {
                if (!filename || filename === "") {
                    filename = el.getAttribute("title");
